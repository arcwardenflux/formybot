...
TEXT5 = "Команда старается проверить оплату, как можно скорее. После успешной оплаты вы сразу получите доступ."
TEXT6 = "🔥 Скидка 50%% в течении 12 часов! 🔥\n\nУспей забрать гайд за полцены — 25 USDT вместо 50."
...
def handle_screenshot(message):
    ...
    if chat_id in user_waiting_for_screenshot:
        ...
        bot.send_message(chat_id, TEXT5)
